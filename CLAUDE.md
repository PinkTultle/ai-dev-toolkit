...
| `coding-standards.md` | C/C++ 임베디드 코딩 표준 | 미작성 (현재 `global_CLAUDE.md` 4절에 포함) |
| `git-workflow.md` | Git 브랜치/커밋/워크트리 규칙 | 미작성 (현재 `global_CLAUDE.md` 5절에 포함) |
| `build-environment.md` | 크로스 컴파일, 빌드 산출물 구조 | 미작성 (현재 `global_CLAUDE.md` 6절에 포함) |
